...
class Teacher(models.Model):
    ...
    #Фото преподавателя
    photo = ResizedImageField(size=[400, 400],validators=[validate_photo, FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png'])], verbose_name = "Фото преподавателя", blank=True, null=True)
